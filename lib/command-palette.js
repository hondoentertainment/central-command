...
const PAGE_ITEMS = [
  { key: "command", title: "Open Command", href: "index.html", keywords: "home dashboard tools deck" },
  { key: "registry", title: "Open Tool Registry", href: "registry.html", keywords: "edit import export backups" },
...
function createOverlay() {
  ...
  overlay.innerHTML = `
    <div class="command-palette-panel">
      ...
      <p class="command-palette-hint" tabindex="0">↑↓ Navigate · Enter Open · Esc Close</p>
    </div>
  `;
  return overlay;
}
