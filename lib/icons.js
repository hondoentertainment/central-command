export const ICON_OPTIONS = [
  ...
  { value: "producer", label: "Producer.ai" },
  { value: "uxpilot", label: "UXpilot" },
...
export const appIcons = {
  ...
  mlb: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#002D72"/>
      <path d="M6 9h12M6 13h12M6 17h8" stroke="#BF0D3E" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  nba: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#17408B"/>
      <path d="M6 9h12M6 13h10M6 17h6" stroke="#C9082A" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  nfl: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#013369"/>
      <path d="M6 9h12M6 13h12M6 17h8" stroke="#D50A0A" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  f1: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#E10600"/>
      <path d="M6 10h12M8 14h8M6 18h6" stroke="#fff" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  ufc: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#D20A0A"/>
      <path d="M6 9h12M6 13h10M6 17h6" stroke="#0A0A0A" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  evernote: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  producer: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8 9v6M12 8v8M16 10v4" stroke="#fff" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  uxpilot: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#6366F1"/>
      <path d="M7 8h10M7 12h8M7 16h5" stroke="#fff" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  lindy: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#6366F1"/>
  ...
  "1password": `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#1B283F"/>
      <path d="M12 6.5a3.5 3.5 0 0 1 3.5 3.5v.5h-1.2a2.3 2.3 0 0 0-2.3 2.3v5.4a2.3 2.3 0 0 0 2.3 2.3h4.4a2.3 2.3 0 0 0 2.3-2.3v-5.4a2.3 2.3 0 0 0-2.3-2.3h-1.2V10a3.5 3.5 0 0 1-7 0v.5h-1.2a2.3 2.3 0 0 0-2.3 2.3v5.4a2.3 2.3 0 0 0 2.3 2.3h.9" stroke="#FFF" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`,
  generic: `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function getIconMarkup(tool) {
  ...
  if (explicit === "custom" && tool?.iconUrl && typeof tool.iconUrl === "string") {
    const url = tool.iconUrl.trim();
    if (/^https?:\/\/\S+$/i.test(url)) {
      return `<img src="${url.replace(/"/g, "&quot;")}" alt="" width="24" height="24" loading="lazy" />`;
    }
  }
  ...
  if (identity.includes("mlb.com") || identity.includes("mlb")) return appIcons.mlb;
  if (identity.includes("nba.com") || identity.includes("nba")) return appIcons.nba;
  if (identity.includes("nfl.com") || identity.includes("nfl")) return appIcons.nfl;
  if (identity.includes("formula1") || identity.includes("f1")) return appIcons.f1;
  if (identity.includes("ufc")) return appIcons.ufc;
  ...
  if (identity.includes("producer")) return appIcons.producer;
  if (identity.includes("uxpilot") || identity.includes("ux pilot")) return appIcons.uxpilot;
  if (identity.includes("lindy")) return appIcons.lindy;
