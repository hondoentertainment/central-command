 ...
 * @property {{ creationTime: string|null, lastSignInTime: string|null }} [metadata]
 */

/**
 * @typedef {Object} CloudToolsData
 * @property {Array} tools
 * @property {string} updatedAt
 */

/**
 * @typedef {Object} CloudNotesData
 * @property {string} notes
 * @property {string} updatedAt
 */

/**
 * @typedef {Object} CloudHistoryData
...
/** @type {Promise<{auth: any, db: any}|null>|null} */
 ...
 * @returns {Promise<FirebaseConfig|null>}
 */
 ...
 * @param {FirebaseConfig|null} config
 * @returns {boolean}
 */
 ...
 * @param {Array} local
 * @param {Array} remote
 * @param {string|null} localUpdatedAt
...
/**
 * Merge tools: last-write-wins by doc-level updatedAt.
 * @param {Array} localTools
 * @param {CloudToolsData|null} cloudData
 * @returns {Array}
 */
...
/**
 * Find the most recent updatedAt timestamp among an array of tools.
 * @param {Array} tools
 * @returns {string|null}
 */
 ...
 * @param {CloudNotesData|null} cloudData
 * @returns {string}
 */
 ...
 * @param {CloudHistoryData|null} cloudData
 * @returns {Array}
 */
