...
function createProfileMenu(current) {
  ...
  headerLink.className = `profile-menu__header page-nav__link${current === "profile" ? " is-active" : ""}`;
  headerLink.dataset.key = "profile";
  headerLink.setAttribute("aria-label", "Open profile");
