...
/**
 * Whether a tool matches a deck/palette search string. Empty or whitespace-only query matches all.
 * Uses case-insensitive substring match; multiple words (split on whitespace) must all appear somewhere
 * in the combined fields.
 * @param {object} tool
 * @param {string} query
 */
export function toolMatchesSearchQuery(tool, query) {
