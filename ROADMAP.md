...
Suggested next features for Central Command:

- **More integrations** — Additional linkable services (e.g. calendar, docs, dashboards) with optional Creative Hub–style quick actions and preferences.
- **Bulk actions** — Multi-select on the command deck and registry: bulk pin/unpin, change category, export selection, or delete.
